...
impl<const START: i32, const END: i32> Check<i32> for RangedI32<START, END> {
    ...
    fn checked_abs(self) -> Self::Output { self.checked_abs() }

    #[inline]

    fn checked_add(self, rhs: i32) -> Self::Output { self.checked_add(rhs) }

    #[inline]

    fn checked_div(self, rhs: i32) -> Self::Output { self.checked_div(rhs) }

    #[inline]

    fn checked_div_euclid(self, rhs: i32) -> Self::Output { self.checked_div_euclid(rhs) }

    #[inline]

    fn checked_mul(self, rhs: i32) -> Self::Output { self.checked_mul(rhs) }

    #[inline]

    fn checked_neg(self) -> Self::Output { self.checked_neg() }

    #[inline]

    fn checked_pow(self, rhs: u32) -> Self::Output { self.checked_pow(rhs) }

    #[inline]

    fn checked_rem(self, rhs: i32) -> Self::Output { self.checked_rem(rhs) }

    #[inline]

    fn checked_rem_euclid(self, rhs: i32) -> Self::Output { self.checked_rem_euclid(rhs) }

    #[inline]

    fn checked_shl(self, rhs: u32) -> Self::Output { self.checked_shl(rhs) }

    #[inline]

    fn checked_shr(self, rhs: u32) -> Self::Output { self.checked_shr(rhs) }

    #[inline]

    fn checked_sub(self, rhs: i32) -> Self::Output { self.checked_sub(rhs) }
}
